                  ...
                  <div class="header-navigation-content">
                    <div class="row">
                      ...
                      <div class="col-md-12 nav-brands">
                        <ul>
                          <li><a href="shop-product-list.html"><img title="esprit" alt="esprit" src="{{url('/').'/assets/pages/img/brands/esprit.jpg'}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="gap" alt="gap" src="{{url('/').'/assets/pages/img/brands/gap.jpg'}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="next" alt="next" src="{{url('/').'/assets/pages/img/brands/next.jpg'}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="puma" alt="puma" src="{{url('/').'/assets/pages/img/brands/puma.jpg'}}"></a></li>
                          <li><a href="shop-product-list.html"><img title="zara" alt="zara" src="{{url('/').'/assets/pages/img/brands/zara.jpg'}}"></a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
