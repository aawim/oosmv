                    ...
                    <div class="content-frame-body">
                      ...
                      {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">                                        
                                    <input type="text" class="form-control" id="subject" name="subject" value="Re: Lorem ipsum dolor sit amet"/>                                
                                </div>                                
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12">                            
                                    <textarea class="summernote_email" id="message" name="message"><p>Hello Dmitry,</p>
