      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="{{ url('manage/home') }}" class="site_title"><i class="fa fa-paw"></i> <span>OOSmv</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="{{ url('/')}}">Client View</a></li>
                      <li><a href="{{ url('manage/home') }}">Admin View</a></li>
        ...
        <footer>
          <div class="pull-right">
            Online Order System <a href="https://www.oosmv.com">OOSMV</a>
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
